...
input_db = Path("/home/shine/OpenWPM/datadir_proxy_test/crawl_dir/crawl-data.sqlite")
ldb = "/home/shine/OpenWPM/datadir_proxy_test/content_dir/content.ldb"
...
out = Path("/data4/shine/WebGraph/result_test/result")
mode = "webgraph"

if __name__ == "__main__":
    pipeline(input_db, ldb, features, filters, out, mode,)
