...
def merging():
    ...
    directory_path = "/yopo-artifact/WebGraph/result_adflush"
    ...
    merged_features.to_csv("/yopo-artifact/WebGraph/result_adflush/merged_features.csv", index=False)
    merged_graph.to_csv("/yopo-artifact/WebGraph/result_adflush/merged_graph.csv", index=False)
    merged_labelled.to_csv("/yopo-artifact/WebGraph/result_adflush/merged_labelled.csv", index=False)
...
def add_label():
    df_a = pd.read_csv('/yopo-artifact/WebGraph/result_adflush/merged_features.csv')
    df_b = pd.read_csv('/yopo-artifact/WebGraph/result_adflush/merged_labelled.csv')
    ...
    df_c.to_csv('/yopo-artifact/WebGraph/result_adflush/merged_features_with_labelled.csv', index=False)
...
def add_label_unmod():
    ...
    # Save the merged dataframe to a new CSV file c.csv
    df_c.to_csv('/yopo-artifact/WebGraph/result/merged_features_with_labelled_adflush.csv', index=False)
