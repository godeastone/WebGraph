...
for idx in range(NUM_CORE):
    ...
    input_db = Path("/yopo-artifact/OpenWPM/datadir_proxy_unmod/crawl_dir/crawl-data_{}.sqlite".format(idx))
    ldb = "/yopo-artifact/OpenWPM/datadir_proxy_unmod/content_dir/content_{}.ldb".format(idx)
    ...
    out = Path("/yopo-artifact/WebGraph/result_webgraph_unmod/result_{}".format(idx))
    mode = "webgraph"
