...
for idx in range(NUM_CORE):
    ...
    input_db = Path("/home/shine/OpenWPM_without_content/datadir_small2/crawl_dir/crawl-data_{}.sqlite".format( idx))
    ldb = "/home/shine/OpenWPM_without_content/datadir_small2/content_dir/content_{}.ldb".format( idx)
    features = Path("/data4/shine/WebGraph/code/features_without_content.yaml")
    filters = Path("/data4/shine/a4_pipeline/ad_Nbackdoor/rendering_stream/filterlists_webgraph")
    out = Path("/data4/shine/WebGraph/result_small2/result_{}".format(idx))
    mode = "webgraph"
