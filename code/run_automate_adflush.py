...
for idx in range(NUM_CORE):
    ...
    input_db = Path("/yopo-artifact/OpenWPM/datadir_proxy_adflush_{}/crawl_dir/crawl-data_{}.sqlite".format(shell, idx))
    ldb = "/yopo-artifact/OpenWPM/datadir_proxy_adflush_{}/content_dir/content_{}.ldb".format(shell, idx)
    ...
    out = Path("/yopo-artifact/WebGraph/result_adflush_{}/result_{}".format(shell, idx))
    mode = "webgraph"
