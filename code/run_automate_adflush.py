...
for idx in range(NUM_CORE):
    ...
    input_db = Path("/yopo-artifact/OpenWPM/datadir_proxy_adflush/crawl_dir/crawl-data_{}.sqlite".format(idx))
    ldb = "/yopo-artifact/OpenWPM/datadir_proxy_adflush/content_dir/content_{}.ldb".format(idx)
    ...
    out = Path("/yopo-artifact/WebGraph/result_adflush/result_{}".format(idx))
    mode = "webgraph"
